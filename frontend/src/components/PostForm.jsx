  ...
  return (
    <div className="min-h-screen flex flex-col items-center bg-gray-100">
      ...
      <header className="bg-gradient-to-r from-indigo-600 to-purple-700 p-8 shadow-md fixed top-0 left-0 w-full z-50">
        ...
        <p className="text-lg text-center text-white opacity-75 mt-2">
          Share your thoughts
        </p>
      </header>
      ...
      <main className="pt-24 pb-16 px-4 md:px-10 w-full max-w-md flex flex-col items-center mt-16">
        <form
          ...
          className="bg-white p-8 rounded-lg shadow-md space-y-4 w-full"
        >
          <div>
          ...
          <button
            type="submit"
            className="w-full py-2 text-base font-semibold text-white bg-indigo-600 rounded-lg hover:bg-indigo-700 transition"
          >
            Create Post
          </button>
        </form>
